 ...
 */
 ...
 const fetchCoordsByIP = function(ip, callback) {
  request(`http://ipwho.is/${ip}`, (error, response, body) => {
    ...
    // have to parse so that it can be read by function
    const parsedBody = JSON.parse(body);

    // console.log(parsedBody); returns the response body
   // parsebody.success has to be true to get the necessary info from the api call
   // 
